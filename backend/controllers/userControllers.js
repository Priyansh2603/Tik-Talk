import User from "../models/userModel.js";import bcrypt from 'bcrypt';
  ...
  // console.log(req.body)
    ...
    try{
        ...
        const data = {
          ...
          We warmly welcome you to Tik-Talk! We are on our journey of connecting the world and welcome you in this journey let's connect together.

          Thank you once again for joining us at Tk-Talk. We look forward to serving you and exceeding your expectations.
...
export const updateUser = async(req,res)=>{
    ...
    if(mongoose.Types.ObjectId.isValid(userId)){
        const newuser = await User.findByIdAndUpdate(userId,updatedData,{new:true});
        res.json(newuser)
    }
    else{
        res.send("false")
